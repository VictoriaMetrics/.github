VictoriaMetrics provides fast, cost-saving, and scalable solutions for Observability: metrics, logs and traces. It delivers high performance and reliability, making it an ideal choice for businesses of all sizes.
...
High-performance, lightweight, zero-config, schema-free database for logs that is easy to use and scales both vertically and horizontally, from very small setups to large-scale deployments handling terabytes per day.
...
VictoriaTraces is a fast and scalable database for traces.
